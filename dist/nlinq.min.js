...
"")==a)return a;if($$(a).isDef())throw"'"+a+"' is not a valid key.";},E=a=>{$$(a).isNumber()||$$(a).isBoolean()||($$(a).isString()&&(a=d?a:a.toLowerCase()),a=JSON.stringify(a,void 0,""));return a},N=a=>{var b=(k,q,r)=>{var v=Object.keys(k);_$(q,"aFunc").isFunction().$_();r=_$(r).isString().default("");for(var x in v)$$(k[v[x]]).isMap()||$$(k[v[x]]).isArray()?b(k[v[x]],q,(""==r?"":r+".")+v[x]):q(v[x],k[v[x]],r,k)},e={};b(a,(k,q,r,v)=>{e[r+(""==r?"":".")+k]=q});return e},p=(a,b,e,k,q,r)=>{if($$(r).isUnDef()&&
$$(a).isMap()){var v=N(a);Object.keys(v).forEach(z=>{p(z,v[z],e,k)})}else{var x=!0;if(q){q=$$(r).isDef();var B=b;b=E(q?b:a);r=E(q?r:B)}else{q=$$(b).isDef();b=E(q?b:a);try{a=q?M(a):void 0}catch(z){if(0<String(z).indexOf("is not a valid key"))x=!1;else throw z;}}0<=e.indexOf("{ki}")&&(e=e.replace(/{ki}/g,$$(b).isString()&&!d?".toLowerCase()":""));0<=e.indexOf("{ski}")&&(e=e.replace(/{ski}/g,$$(b).isString()&&!d?"String(":""));0<=e.indexOf("{eki}")&&(e=e.replace(/{eki}/g,$$(b).isString()&&!d?").toLowerCase()":
...
b[k].push(e)});return b},countBy:(a,b,e)=>{a=_$(a).isString().default("key");b=_$(b).isString().default("_count");e=_$(e).isString().default(a);var k=a.split(","),q=e.split(","),r=[],v=(x,B,z)=>{Object.keys(x).forEach((G,O)=>{z[q[B]]=G;B+1<k.length&&v(nLinq(x[G]).group(k[B+1]),B+1,z);k.length==B+1&&(z[b]=x[G].length,r.push(clone(z)))})};return 0<k.length?(v(c.group(k[0]),0,{}),r):[]},at:a=>{_$(a,"index").isNumber().$_();g=u(g);return g[Number(a)]},all:a=>{g=u(g);return $$(g).isArray()?g.length==h.length:
a},count:()=>{g=u(g);return g.length},first:a=>{g=u(g);return 0<g.length?g[0]:a},last:a=>{g=u(g);return 0<g.length?g[g.length-1]:a},any:()=>{g=u(g);return 0<g.length},none:()=>{g=u(g);return 0==g.length},reverse:()=>{g=u(g);return g.reverse()},each:a=>{_$(a,"each function").isFunction().$_();c.select(a);return c},intersect:a=>{_$(a,"intersect param").isArray().$_();g=u(g);g=J(g,a);return c},except:a=>{_$(a,"except param").isArray().$_();g=u(g);g=I(g,a);return c},union:a=>{_$(a,"union param").isArray().$_();
g=u(g);g=K(g,a);return c},cartesian:a=>{_$(a,"cartesian param").isArray().$_();g=u(g);g=L(g,a);return c},attach:(a,b)=>{_$(a,"key").$_();_$(b,"value").$_();g=u(g);g=$$(b).isFunction()?g.map(e=>{$$(e).set(a,b(e));return e}):g.map(e=>{$$(e).set(a,b);return e});return c},toDate:a=>{_$(a,"key").$_();g=u(g);g.forEach(b=>{try{var e=$$(b).get(a);($$(e).isString()||$$(e).isNumber())&&$$(b).set(a,new Date(e))}catch(k){}});return c},filter:a=>{_$(a,"value").$_();g=u(g);g=g.filter(b=>{var e=!0;$$(a).isMap()&&
$$(b).isMap()&&Object.keys(a).forEach(k=>{F(a[k],b[k])||(e=!1)});$$(b).isArray()&&0>H(b,a)&&(e=!1);$$(a).isFunction()&&!a(b)&&(e=!1);($$(a).isNumber()||$$(a).isString())&&($$(b).isNumber()||$$(b).isString())&&b!=a&&(e=!1);return e});return c},sort:function(){var a="";g=u(g);for(var b=0;b<arguments.length;b++){var e=arguments[b],k=!1;e.startsWith("-")&&(k=!0,e=e.substr(1,e.length-1));a=0<a.length?a+" || ":"return ";a=k?a+(' ($$(a).get("'+e+'") > $$(b).get("'+e+'") ? -1 : ($$(a).get("'+e+'") < $$(b).get("'+
e+'") ? 1 : 0)) '):a+(' ($$(a).get("'+e+'") > $$(b).get("'+e+'") ? 1 : ($$(a).get("'+e+'") < $$(b).get("'+e+'") ? -1 : 0)) ')}g=g.sort(new Function("a","b",a));return c},assign:(a,b,e,k,q)=>{g=u(g);g.forEach(r=>{r[b]=nLinq(a).equals(k,$$(r).get(e)).first(q)});return c},join:(a,b,e,k)=>{g=u(g);g.forEach(q=>{q[b]=nLinq(a).equals(k,$$(q).get(e)).select()});return c},skip:a=>{_$(a).isNumber().$_();y=a;return c},skipWhile:a=>{_$(a,"skip function").isFunction().$_();c.notWhere(a);return c},takeWhile:a=>
{_$(a,"take function").isFunction().$_();c.where(a);return c},take:a=>{_$(a).isNumber().$_();return c.limit(a)},skipTake:(a,b)=>{_$(a).isNumber().$_();return c.skip(a).take(b)},apply:a=>{a=_$(a,"aMap").isMap().default({});a.where=_$(a.where,"where").isArray().default([]);a.select=_$(a.select,"select").default(void 0);a.transform=_$(a.transform,"transform").isArray().default([]);a.selector=_$(a.selector,"selector").isMap().default(void 0);a.where.forEach(e=>{$$(e.cond).isString()&&(c=c[e.cond].apply(c,
e.args))});a.transform.forEach(e=>{$$(e.func).isString()&&(c=c[e.func].apply(c,e.args))});var b;$$(a.select).isString()&&(b=c.tselect(new Function("elem","index","array",a.select)));$$(a.select).isMap()&&(b=c.select(a.select));$$(b).isUnDef()&&$$(a.selector).isMap()&&(b=$$(a.selector.func).isString()?$$({}).set(a.selector.func,c[a.selector.func].apply(c,a.selector.args)):b);$$(b).isUnDef()&&$$(a.select).isUnDef()&&(b=c.select());return b},select:a=>{g=u(g);if($$(a).isUnDef())return g;if($$(a).isFunction())return g.map(a);
if($$(a).isArray()){var b={};a.forEach(k=>{if($$(k).isString())if(0<k.indexOf(":")){var q=k.substring(0,k.indexOf(":"));k=k.substring(k.indexOf(":")+1);b[q]=k}else b[k]=k});return g.map(k=>{var q={};Object.keys(b).forEach(r=>$$(q).set(r,$$(k).get(b[r])));return q})}if($$(a).isMap()){var e=Object.keys(a);return g.map(k=>{var q={};e.forEach(r=>{$$($$(k).get(r)).isDef()?$$(q).set(r,$$(k).get(r)):$$(q).set(r,$$(a).get(r))});return q})}},mselect:(a,b,e)=>{a=c.select(a);b=_$(b,"aKey").isString().default("_key");
e=_$(e,"dontRemove").isBoolean().default(!0);var k={},q;for(q in a){var r=a[q];if($$(b).isDef()&&$$(r[b]).isDef()){var v=r[b];k[v]=r;e||delete k[v][b]}else k["row"+q]=r}return k},define:a=>{g=c.select(a);return c},removed:a=>{C=!0;g=c.select(a);return c},stream:a=>{var b=0<t?t:1;a=c.streamFn(a);do a(),0<t&&b--;while($$(g).isDef()&&0<b)},streamFn:a=>()=>{var b=c.select(a);g=$$(h).isFunction()?h():h;return b},query:a=>{a=_$(a,"aMap").isMap().default({});a.where=_$(a.where,"where").isArray().default([]);
a.select=_$(a.select,"select").default(void 0);a.transform=_$(a.transform,"transform").isArray().default([]);a.selector=_$(a.selector,"selector").isMap().default(void 0);a.where.forEach(e=>{$$(e.cond).isString()&&(c=c[e.cond].apply(c,e.args))});a.transform.forEach(e=>{$$(e.func).isString()&&(c=c[e.func].apply(c,e.args))});var b;$$(a.select).isString()&&(b=c.tselect(newFn("elem","index","array",a.select)));$$(a.select).isMap()&&(b=c.select(a.select));$$(b).isUnDef()&&$$(a.selector).isMap()&&(b=$$(a.selector.func).isString()?
c[a.selector.func].apply(c,a.selector.args):b);$$(b).isUnDef()&&$$(a.select).isUnDef()&&(b=c.select());return b}};return c},$from=nLinq;"defined"!=typeof isJavaObject&&(isJavaObject=()=>!1);
