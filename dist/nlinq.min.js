/*v:0.1.3;a:Nuno Aguiar*/
var nLinq_USE_CASE=!1,nLinq=function(h,l){$$(h).isMap()&&(l=_$(l,"aKey").isString().default("_key"),h=Object.keys(h).map(a=>{$$(h[a]).isMap()&&(h[a][l]=a);return h[a]}));var g=h,m="",d=nLinq_USE_CASE,f=!1,n=!1,t=0,y=0,C=!1,w=[],F=function(a,b){if(null===a||void 0===a||null===b||void 0===b)return a===b;if(a.constructor!==b.constructor)return!1;if(a instanceof Function||a instanceof RegExp)return a===b;if(a===b||a.valueOf()===b.valueOf())return!0;if(Array.isArray(a)&&a.length!==b.length||a instanceof
Date||!(a instanceof Object)||!(b instanceof Object))return!1;var e=Object.keys(a),k=Object.keys(b);if(e.length!=k.length)return!1;for(var q in a)if(e=a[q],$$(b[q]).isUnDef()||!F(e,b[q]))return!1;return!0},H=function(a,b,e){_$(a).isArray().$_();var k,q=!1;for(k=0;k<a.length&&!q;k++){var r=$$(e).isFunction()?e(a[k]):a[k];F(b,r)&&(q=!0)}return q?k-1:-1},A=function(a){if(!$$(a).isMap())return a;var b={};Object.keys(a).sort().forEach(e=>{b[e]=$$(a[e]).isMap()?A(a[e]):a[e]});return b},I=function(a,b){var e=
b.map(k=>JSON.stringify(A(k),void 0,""));return a.filter(k=>0>e.indexOf(JSON.stringify(A(k),void 0,"")))},J=function(a,b){var e=b.map(k=>JSON.stringify(A(k),void 0,""));return a.filter(k=>0<=e.indexOf(JSON.stringify(A(k),void 0,"")))},K=function(a,b){var e=a.map(k=>JSON.stringify(A(k),void 0,""));return a.concat(b.filter(k=>0>e.indexOf(JSON.stringify(A(k),void 0,""))))},L=function(a,b){return a.map(e=>b.map(k=>isMap(k)?merge(e,k):[e,k])).reduce((e,k)=>e.concat(k))},v=(a,b)=>{$$(a).isFunction()&&(a=
a());$$(a).isArray()||(a=[a]);if(!$$(a).isUnDef()){if(0==m.length){if(C)return[];0!=y&&(a=a.slice(y));return 0!=t?a.slice(0>t?t:0,0<t?t:void 0):a}m=m.replace(/;/g," ");var e=$$(b).isFunction()?b:new Function("r","whereFn","return $$(r).isDef() ? ("+m+") : void 0");g=0!=t?C?a.filter(k=>!e(k,w)).slice(0>t?t:0,0<t?t:void 0):a.filter(k=>e(k,w)).slice(0>t?t:0,0<t?t:void 0):C?a.filter(k=>!e(k,w)):a.filter(k=>e(k,w));0!=y&&(g=g.slice(y));return g}},M=a=>{if($$(a).isString()&&a.replace(/^[^a-zA-Z_$]|[^\w\[\]\.$]/g,
"")==a)return a;if($$(a).isDef())throw"'"+a+"' is not a valid key.";},E=a=>{$$(a).isNumber()||$$(a).isBoolean()||($$(a).isString()&&(a=d?a:a.toLowerCase()),a=JSON.stringify(a,void 0,""));return a},N=a=>{var b=(k,q,r)=>{var u=Object.keys(k);_$(q,"aFunc").isFunction().$_();r=_$(r).isString().default("");for(var x in u)$$(k[u[x]]).isMap()||$$(k[u[x]]).isArray()?b(k[u[x]],q,(""==r?"":r+".")+u[x]):q(u[x],k[u[x]],r,k)},e={};b(a,(k,q,r,u)=>{e[r+(""==r?"":".")+k]=q});return e},p=(a,b,e,k,q,r)=>{if($$(r).isUnDef()&&
$$(a).isMap()){var u=N(a);Object.keys(u).forEach(z=>{p(z,u[z],e,k)})}else{var x=!0;if(q){q=$$(r).isDef();var B=b;b=E(q?b:a);r=E(q?r:B)}else{q=$$(b).isDef();b=E(q?b:a);try{a=q?M(a):void 0}catch(z){if(0<String(z).indexOf("is not a valid key"))x=!1;else throw z;}}0<=e.indexOf("{ki}")&&(e=e.replace(/{ki}/g,$$(b).isString()&&!d?".toLowerCase()":""));0<=e.indexOf("{ski}")&&(e=e.replace(/{ski}/g,$$(b).isString()&&!d?"String(":""));0<=e.indexOf("{eki}")&&(e=e.replace(/{eki}/g,$$(b).isString()&&!d?").toLowerCase()":
""));e=q?e.replace(/{k}/g,x?"r."+a:"$$$$(r).get("+JSON.stringify(a)+")"):e.replace(/{k}/g,"r");$$(b).isString()&&(b=b.replace(/\$/g,"$$$"));$$(r).isDef()?($$(r).isString()&&(r=r.replace(/\$/g,"$$$")),r=E(r),e=e.replace(/{v}/g,b).replace(/{v2}/g,r)):e=e.replace(/{v}/g,b);D(e,k)}},D=(a,b)=>{b=_$(b).default(f);0<m.length&&(m=b?"("+m+") || ":m+" && ");m+="("+a+")"},c={_setState:a=>{_$(a,"map").isMap().$_();m=a.where;d=a.useCase;f=a.useOr;n=a.useNot;t=a.alimit;y=a.askip;C=a.negative;w=a.whereFn;return c},
...
b[k].push(e)});return b},groupBy:a=>{a=_$(a).isString().default("key");var b=a.split(",");a={};var e=(k,q,r)=>{Object.keys(k).forEach((u,x)=>{r[u]={};q+1<b.length&&e(nLinq(k[u]).group(b[q+1]),q+1,r[u]);b.length==q+1&&(r[u]=k[u])})};return 0<b.length?(e(c.group(b[0]),0,a),a):[]},countBy:(a,b,e)=>{a=_$(a).isString().default("key");b=_$(b).isString().default("_count");e=_$(e).isString().default(a);var k=a.split(","),q=e.split(","),r=[],u=(x,B,z)=>{Object.keys(x).forEach((G,O)=>{z[q[B]]=G;B+1<k.length&&
u(nLinq(x[G]).group(k[B+1]),B+1,z);k.length==B+1&&(z[b]=x[G].length,r.push(clone(z)))})};return 0<k.length?(u(c.group(k[0]),0,{}),r):[]},at:a=>{_$(a,"index").isNumber().$_();g=v(g);return g[Number(a)]},all:a=>{g=v(g);return $$(g).isArray()?g.length==h.length:a},count:()=>{g=v(g);return g.length},first:a=>{g=v(g);return 0<g.length?g[0]:a},last:a=>{g=v(g);return 0<g.length?g[g.length-1]:a},any:()=>{g=v(g);return 0<g.length},none:()=>{g=v(g);return 0==g.length},reverse:()=>{g=v(g);return g.reverse()},
each:a=>{_$(a,"each function").isFunction().$_();c.select(a);return c},intersect:a=>{_$(a,"intersect param").isArray().$_();g=v(g);g=J(g,a);return c},except:a=>{_$(a,"except param").isArray().$_();g=v(g);g=I(g,a);return c},union:a=>{_$(a,"union param").isArray().$_();g=v(g);g=K(g,a);return c},cartesian:a=>{_$(a,"cartesian param").isArray().$_();g=v(g);g=L(g,a);return c},attach:(a,b)=>{_$(a,"key").$_();_$(b,"value").$_();g=v(g);g=$$(b).isFunction()?g.map(e=>{$$(e).set(a,b(e));return e}):g.map(e=>{$$(e).set(a,
b);return e});return c},toDate:a=>{_$(a,"key").$_();g=v(g);g.forEach(b=>{try{var e=$$(b).get(a);($$(e).isString()||$$(e).isNumber())&&$$(b).set(a,new Date(e))}catch(k){}});return c},filter:a=>{_$(a,"value").$_();g=v(g);g=g.filter(b=>{var e=!0;$$(a).isMap()&&$$(b).isMap()&&Object.keys(a).forEach(k=>{F(a[k],b[k])||(e=!1)});$$(b).isArray()&&0>H(b,a)&&(e=!1);$$(a).isFunction()&&!a(b)&&(e=!1);($$(a).isNumber()||$$(a).isString())&&($$(b).isNumber()||$$(b).isString())&&b!=a&&(e=!1);return e});return c},
sort:function(){var a="";g=v(g);for(var b=0;b<arguments.length;b++){var e=arguments[b],k=!1;e.startsWith("-")&&(k=!0,e=e.substr(1,e.length-1));a=0<a.length?a+" || ":"return ";a=k?a+(' ($$(a).get("'+e+'") > $$(b).get("'+e+'") ? -1 : ($$(a).get("'+e+'") < $$(b).get("'+e+'") ? 1 : 0)) '):a+(' ($$(a).get("'+e+'") > $$(b).get("'+e+'") ? 1 : ($$(a).get("'+e+'") < $$(b).get("'+e+'") ? -1 : 0)) ')}g=g.sort(new Function("a","b",a));return c},assign:(a,b,e,k,q)=>{g=v(g);g.forEach(r=>{r[b]=nLinq(a).equals(k,
$$(r).get(e)).first(q)});return c},join:(a,b,e,k)=>{g=v(g);g.forEach(q=>{q[b]=nLinq(a).equals(k,$$(q).get(e)).select()});return c},skip:a=>{_$(a).isNumber().$_();y=a;return c},skipWhile:a=>{_$(a,"skip function").isFunction().$_();c.notWhere(a);return c},takeWhile:a=>{_$(a,"take function").isFunction().$_();c.where(a);return c},take:a=>{_$(a).isNumber().$_();return c.limit(a)},skipTake:(a,b)=>{_$(a).isNumber().$_();return c.skip(a).take(b)},apply:a=>{a=_$(a,"aMap").isMap().default({});a.where=_$(a.where,
"where").isArray().default([]);a.select=_$(a.select,"select").default(void 0);a.transform=_$(a.transform,"transform").isArray().default([]);a.selector=_$(a.selector,"selector").isMap().default(void 0);a.where.forEach(e=>{$$(e.cond).isString()&&(c=c[e.cond].apply(c,e.args))});a.transform.forEach(e=>{$$(e.func).isString()&&(c=c[e.func].apply(c,e.args))});var b;$$(a.select).isString()&&(b=c.tselect(new Function("elem","index","array",a.select)));$$(a.select).isMap()&&(b=c.select(a.select));$$(b).isUnDef()&&
$$(a.selector).isMap()&&(b=$$(a.selector.func).isString()?$$({}).set(a.selector.func,c[a.selector.func].apply(c,a.selector.args)):b);$$(b).isUnDef()&&$$(a.select).isUnDef()&&(b=c.select());return b},select:a=>{g=v(g);if($$(a).isUnDef())return g;if($$(a).isFunction())return g.map(a);if($$(a).isArray()){var b={};a.forEach(k=>{if($$(k).isString())if(0<k.indexOf(":")){var q=k.substring(0,k.indexOf(":"));k=k.substring(k.indexOf(":")+1);b[q]=k}else b[k]=k});return g.map(k=>{var q={};Object.keys(b).forEach(r=>
$$(q).set(r,$$(k).get(b[r])));return q})}if($$(a).isMap()){var e=Object.keys(a);return g.map(k=>{var q={};e.forEach(r=>{$$($$(k).get(r)).isDef()?$$(q).set(r,$$(k).get(r)):$$(q).set(r,$$(a).get(r))});return q})}},mselect:(a,b,e)=>{a=c.select(a);b=_$(b,"aKey").isString().default("_key");e=_$(e,"dontRemove").isBoolean().default(!0);var k={},q;for(q in a){var r=a[q];if($$(b).isDef()&&$$(r[b]).isDef()){var u=r[b];k[u]=r;e||delete k[u][b]}else k["row"+q]=r}return k},define:a=>{g=c.select(a);return c},removed:a=>
{C=!0;g=c.select(a);return c},stream:a=>{var b=0<t?t:1;a=c.streamFn(a);do a(),0<t&&b--;while($$(g).isDef()&&0<b)},streamFn:a=>()=>{var b=c.select(a);g=$$(h).isFunction()?h():h;return b},query:a=>{a=_$(a,"aMap").isMap().default({});a.where=_$(a.where,"where").isArray().default([]);a.select=_$(a.select,"select").default(void 0);a.transform=_$(a.transform,"transform").isArray().default([]);a.selector=_$(a.selector,"selector").isMap().default(void 0);a.where.forEach(e=>{$$(e.cond).isString()&&(c=c[e.cond].apply(c,
...
h[d];else return}return h}},set:(l,g)=>{if($$(h).isObject()){var m=h;l=l.replace(/\[(\w+)\]/g,".$1");l=l.replace(/^\./,"");l=l.split(".");for(var d,f,n=0,t=l.length;n<t;++n){var y=l[n];d=h;f=y;y in h||(h[y]={});h=h[y]}d[f]=g;return m}},isDef:()=>isJavaObject(h)||"undefined"!=typeof h?!0:!1,isUnDef:()=>isJavaObject(h)||"undefined"!=typeof h?!1:!0,isJavaObject:()=>isJavaObjecta(h),isArray:()=>Array.isArray(h),isMap:()=>"[object Object]"==Object.prototype.toString.call(h),isObject:()=>{var l=typeof h;
return"function"===l||"object"===l&&!!h},isFunction:()=>"function"==typeof h||!1,isString:()=>"string"==typeof h||!1,isNumber:()=>!isNaN(parseFloat(h))&&isFinite(h),isTNumber:()=>"number"==typeof h||!1,isBoolean:()=>"boolean"==typeof h||!1,isNull:()=>null==h||!1,isDate:()=>null!=h&&!isNaN(h)&&"undefined"!==typeof h.getDate,isRegExp:()=>h instanceof RegExp,isUUID:()=>h.match(/^\b[0-9a-f]{8}\b-[0-9a-f]{4}-[0-9a-f]{4}-[0-9a-f]{4}-\b[0-9a-f]{12}\b$/)?!0:!1,isSchema:(l,g)=>{if("undefined"==typeof Ajv)if("undefined"!=
typeof loadAjv)loadAjv();else throw"Ajv library not loaded.";ow.loadObj();return ow.obj.schemaValidate(l,h,g)}}},_$=function(h,l){l=$$(l).isDef()?l+" ":"";var g=$$(h).isDef()?!0:!1;const m={default:d=>g?h:d,$_:d=>{$$(d).isUnDef()&&(d=l+"not defined or assigned");if(!g)throw d;return h},isNumber:d=>{$$(d).isUnDef()&&(d=l+"is not a number");if(g&&!$$(h).isNumber())throw d;return m},toNumber:d=>{$$(d).isUnDef()&&(d=l+"can't be converted to number");if(g)try{h=Number(h)}catch(f){throw d;}return m},isTNumber:d=>
{$$(d).isUnDef()&&(d=l+"is not a number type");if(g&&!$$(h).isTNumber())throw d;return m},isString:d=>{$$(d).isUnDef()&&(d=l+"is not a string");if(g&&!$$(h).isString())throw d;return m},toString:d=>{$$(d).isUnDef()&&(d=l+"can't be converted to string");if(g)try{h=String(h)}catch(f){throw d;}return m},isBoolean:d=>{$$(d).isUnDef()&&(d=l+"is not boolean");if(g&&"boolean"!==typeof h)throw d;return m},toBoolean:d=>{$$(d).isUnDef()&&(d=l+"can't be converted to a boolean");if(g)try{$$(h).isNumber()&&(h=
!!h),$$(h).isString()&&(h="true"==h.trim().toLowerCase())}catch(f){throw d;}return m},isArray:d=>{$$(d).isUnDef()&&(d=l+"is not an array");if(g&&!$$(h).isArray())throw d;return m},toArray:d=>{$$(d).isUnDef()&&(d=l+"can't be converted to an array");if(g)try{h=String(h).split(",").map(f=>f.trim())}catch(f){throw d;}return m},isMap:d=>{$$(d).isUnDef()&&(d=l+"is not a map");if(g&&!$$(h).isMap())throw d;return m},toMap:d=>{$$(d).isUnDef()&&(d=l+"can't be converted to a map");if(g)try{var f=h;h=$$(global.jsonParse).isFunction()?
global.jsonParse(f,!0):JSON.parse(f)}catch(n){throw d;}return m},isObject:d=>{$$(d).isUnDef()&&(d=l+"is not an object");if(g&&!$$(h).isObject())throw d;return m},isDate:d=>{$$(d).isUnDef()&&(d=l+"is not a date");if(g&&!$$(h).isDate())throw d;return m},toDate:d=>{$$(d).isUnDef()&&(d=l+"can't be converted to date");if(g)try{h=new Date(h)}catch(f){throw d;}return m},isRegExp:d=>{$$(d).isUnDef()&&(d=l+"is not a RegExp");if(g&&!$$(h).isRegExp())throw d;return m},isFunction:d=>{$$(d).isUnDef()&&(d=l+"is not a function");
if(g&&!$$(h).isFunction())throw d;return m},isJavaObject:d=>{$$(d).isUnDef()&&(d=l+"is not a java object");if(g&&!isJavaObject(h))throw d;return m},isInstanceOf:(d,f)=>{$$(f).isUnDef()&&(f=l+"is not an instance of "+d);if(g&&!(h instanceof d))throw f;return m},isNotNull:d=>{$$(d).isUnDef()&&(d=l+"is null");if(g&&null==h)throw d;return m},isUUID:d=>{$$(d).isUnDef()&&(d=l+"is not an UUID");if(g&&(!$$(h).isString()||h.match(/^\b[0-9a-f]{8}\b-[0-9a-f]{4}-[0-9a-f]{4}-[0-9a-f]{4}-\b[0-9a-f]{12}\b$/)))throw d;
return m},isSchema:(d,f,n)=>{if("undefined"==typeof Ajv)if("undefined"!=typeof loadAjv)loadAjv();else throw"Ajv library not loaded.";ow.loadObj();try{ow.obj.schemaValidate(d,h,n)}catch(t){throw $$(f).isUnDef()&&(f=l+" "+String(t)),f;}return m},check:(d,f)=>{if(!$$(d).isFunction()&&!$$(d).isString())throw"please provide a function to check";d=$$(d).isFunction()?d(h):newFn("v","return "+d)(h);$$(f).isUnDef()&&(f=l+"is not ok");if(g&&!d)throw f;return m},expr:(d,f)=>{if(!$$(d).isString())throw"please provide an expression";
d=af.eval(templify(d,{v:h}));$$(f).isUnDef()&&(f=l+"is not ok");if(g&&!d)throw f;return m},equals:(d,f)=>{$$(f).isUnDef()&&(f=l+"is equals to "+d);if(g&&h==d)throw f;return m},notEquals:(d,f)=>{$$(f).isUnDef()&&(f=l+"is not equals to "+d);if(g&&h!=d)throw f;return m},anyOf:(d,f)=>{if(!$$(d).isArray())throw"please provide an array of values";$$(f).isUnDef()&&(f=l+"has a value not in "+JSON.stringify(d));g&&$$(h).isArray()&&h.forEach(n=>{if(0>d.indexOf(n))throw f;});return m},oneOf:(d,f)=>{if(!$$(d).isArray())throw"please provide an array of values";
